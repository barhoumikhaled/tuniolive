  ...
  function handlePrint() {
    ...
    const rowsHtml = statement.invoices.map((inv) => {
      ...
      return `<tr>
        ...
        <td style="border:1px solid #ddd;padding:6px 10px;text-align:right">${inv.amount > 0 ? "$" + inv.amount.toFixed(2) : "—"}</td>
        ...
        <td style="border:1px solid #ddd;padding:6px 10px;text-align:center"><span style="background:${inv.paymentStatus === "Paid" ? "#dcfce7" : "#fef3c7"};color:${inv.paymentStatus === "Paid" ? "#166534" : "#92400e"};padding:2px 8px;border-radius:9999px;font-size:11px">${inv.paymentStatus ?? "Pending"}</span></td>
      </tr>`;
    }).join("");
...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  <table style="margin-bottom:24px">
    <tr>
      <td style="vertical-align:top;width:50%">
        <img src="${logoUrl}" style="height:60px;object-fit:contain" onerror="this.outerHTML='<strong>TuniOlive</strong>'" alt="TuniOlive"/>
      ...
      <td style="text-align:right;vertical-align:top">
        <div style="font-size:20px;font-weight:800;text-transform:uppercase;letter-spacing:1px">Account Statement</div>
  ...
  <div style="background:#f9fafb;border:1px solid #e5e7eb;border-radius:8px;padding:16px;margin-bottom:20px">
    <div style="font-size:13px;font-weight:700;margin-bottom:4px">Billed To:</div>
    <div style="font-size:16px;font-weight:800">${statement.customerName}</div>
  </div>

  <table style="border:1px solid #e5e7eb;border-radius:8px;overflow:hidden;margin-bottom:20px">
