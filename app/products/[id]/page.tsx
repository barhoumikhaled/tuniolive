...
export default async function ProductDetailPage(
  ...
  //           <TabsTrigger value="details">TuniOlive Details</TabsTrigger>
  //           <TabsTrigger value="tasting">TuniOlive Tasting Notes</TabsTrigger>
  //           <TabsTrigger value="awards">TuniOlive Key Features</TabsTrigger>
